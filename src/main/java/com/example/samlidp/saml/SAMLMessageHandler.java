...
import static com.example.samlidp.saml.SAMLBuilder.buildAssertion;
import static com.example.samlidp.saml.SAMLBuilder.buildIssuer;
import static com.example.samlidp.saml.SAMLBuilder.buildSAMLObject;
import static com.example.samlidp.saml.SAMLBuilder.buildStatus;
import static com.example.samlidp.saml.SAMLBuilder.signAssertion;
...
public class SAMLMessageHandler {
  ...
  public SAMLMessageHandler(KeyManager keyManager, Collection<SAMLMessageDecoder> decoders, SAMLMessageEncoder encoder,
      SecurityPolicyResolver securityPolicyResolver, IdpConfiguration idpConfiguration, String idpBaseUrl)
